...
def test_apply_defaults_sets_validated_paper_config(client):
    ...
    # Seed a non-"1" value to prove apply-defaults leaves live_max_contracts alone.
    set_setting("live_max_contracts", "5")
    ...
    # apply-defaults must NOT reset the live-side cap.
    assert get_setting("live_max_contracts") == "5"
